...
$(function(){
  ...
  // 'aboutme' 섹션의 추가 오프셋 설정
  var aboutmeOffset = 100; // 원하는 추가 오프셋 값 (픽셀 단위로 설정)
  var aboutmeIndex = $('#aboutme').index('section'); // 'aboutme' 섹션의 인덱스
  arrTopVal[aboutmeIndex] += aboutmeOffset; // 추가 오프셋 적용
  //header
